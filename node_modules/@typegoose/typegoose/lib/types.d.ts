...
import type { Severity, WhatIsIt } from '@typegoose/typegoose/lib/internal/constants';
/**
 ...
 */
export declare type ModelType<T, QueryHelpers = {}> = mongoose.Model<DocumentType<T>, QueryHelpers>;
/**
...
export declare type Ref<R, T extends RefType = (R extends {
    _id?: RefType;
} ? NonNullable<R['_id']> : mongoose.Types.ObjectId) | undefined> = R | T;
/**
