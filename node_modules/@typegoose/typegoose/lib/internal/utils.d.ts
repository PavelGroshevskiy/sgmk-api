...
import type { AnyParamConstructor, Func, GetTypeReturn, IObjectWithTypegooseFunction, IObjectWithTypegooseName, IPrototype, KeyStringAny, PropOptionsForNumber, PropOptionsForString, VirtualOptions } from '@typegoose/typegoose/lib/types';
import { DecoratorKeys, WhatIsIt } from '@typegoose/typegoose/lib/internal/constants';
/**
