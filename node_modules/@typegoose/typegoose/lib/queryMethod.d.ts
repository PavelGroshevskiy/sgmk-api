...
import type { AnyParamConstructor, ReturnModelType } from '@typegoose/typegoose/lib/types';
/**
 ...
 * ```
 */
export declare function queryMethod<QueryHelpers, U extends AnyParamConstructor<any>>(func: (this: ReturnModelType<U, QueryHelpers>, ...params: any[]) => DocumentQuery<any, any>): ClassDecorator;
