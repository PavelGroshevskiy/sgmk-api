...
import { setGlobalOptions } from '@typegoose/typegoose/lib/globalOptions';
import type { AnyParamConstructor, DocumentType, IModelOptions, Ref, ReturnModelType } from '@typegoose/typegoose/lib/types';
export { mongoose, setGlobalOptions };
export { setLogLevel, LogLevels } from '@typegoose/typegoose/lib/logSettings';
export * from '@typegoose/typegoose/lib/prop';
export * from '@typegoose/typegoose/lib/hooks';
export * from '@typegoose/typegoose/lib/plugin';
export * from '@typegoose/typegoose/lib';
export * from '@typegoose/typegoose/lib/modelOptions';
export * from '@typegoose/typegoose/lib/queryMethod';
export * from '@typegoose/typegoose/lib/typeguards';
export * as defaultClasses from '@typegoose/typegoose/lib/defaultClasses';
export * as errors from '@typegoose/typegoose/lib/internal/errors';
export * as types from '@typegoose/typegoose/lib/types';
export { DocumentType, Ref, ReturnModelType };
export { getClassForDocument, getClass, getName } from '@typegoose/typegoose/lib/internal/utils';
export { Severity } from '@typegoose/typegoose/lib/internal/constants';
/**
 ...
 * ```
 */
export declare function addModelToTypegoose<U extends AnyParamConstructor<any>, QueryHelpers = {}>(model: mongoose.Model<any>, cl: U, options?: {
